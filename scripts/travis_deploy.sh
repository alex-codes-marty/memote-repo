...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "alexandremartens/memote-repo" ]]; then
...
echo "Your new report will be visible at https://alexandremartens.github.io/memote-repo in a moment."
